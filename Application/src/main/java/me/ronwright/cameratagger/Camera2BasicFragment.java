...
public class Camera2BasicFragment extends Fragment
    ...
    /**
     * A {@link TextView} for Clarifai tags.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(me.ronwright.cameratagger.R.layout.fragment_camera2_basic, container, false);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ErrorDialog.newInstance(getString(me.ronwright.cameratagger.R.string.request_permission))
            ...
            case me.ronwright.cameratagger.R.id.info: {
                ...
                if (null != activity) {
                    new AlertDialog.Builder(activity)
                            .setMessage(me.ronwright.cameratagger.R.string.intro_message)
    ...
    private static class ImageSaver implements Runnable {
        ...
        /**
         * The textview we display the Clarifai tags.
         */
    ...
    public static class ConfirmationDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    .setMessage(me.ronwright.cameratagger.R.string.request_permission)
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
